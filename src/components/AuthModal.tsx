      ...
      <DialogPortal>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-blue-900/50 border border-blue-500/20">
            <TabsTrigger
              value="signin"
              className="data-[state=active]:bg-blue-600 data-[state=active]:text-white text-blue-300 font-light"
            >
              Sign In
            </TabsTrigger>
            <TabsTrigger
          ...
          <TabsContent value="signin" className="space-y-4 mt-6">
            <p className="text-sm text-blue-200/70 text-center mb-4 font-light">
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-blue-500 to-cyan-400 hover:from-blue-600 hover:to-cyan-500 text-white font-light py-2 rounded-lg transition-all duration-300 disabled:opacity-50"
            >
              {isLoading ? (
                <>
            ...
            <div className="space-y-3">
              ...
              <Button
                disabled
                className="w-full bg-blue-600/50 text-blue-300 cursor-not-allowed font-light"
              >
                Sign In
              </Button>
            </div>

            <p className="text-xs text-blue-300/50 text-center font-light">
        ...
        <p className="text-xs text-blue-300/40 text-center mt-6 font-light">
