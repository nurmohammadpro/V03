    ...
    <div className="fixed inset-0 flex flex-col items-center justify-center z-10 px-4 md:px-6">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8 md:mb-12">
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-normal mb-4 tracking-normal">
            <span className="bg-gradient-to-r from-blue-300 via-blue-400 to-cyan-300 bg-clip-text text-transparent">
              Build Anything
            </span>
          </h1>
          <p className="text-lg md:text-xl text-blue-200/60 font-normal">
          ...
          <div className="relative">
            <div className="relative bg-black/70 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-4 md:p-6 transition-none">
              <textarea
                ...
                className="w-full bg-transparent text-lg md:text-xl text-white/90 placeholder-blue-300/40 resize-none focus:outline-none h-24 md:h-28 font-normal"
                disabled={isLoading}
              />
              ...
              <div className="flex justify-end mt-4">
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-500/80 to-cyan-400/80 hover:from-blue-500 hover:to-cyan-400 text-white font-normal px-6 md:px-8 py-2 md:py-3 rounded-lg transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <>
        ...
        <p className="text-center text-sm md:text-base text-blue-300/40 mt-6 md:mt-8 font-normal">
